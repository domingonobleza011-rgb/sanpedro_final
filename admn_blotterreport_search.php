                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-left">
                                ...
                                <p><strong>Address:</strong><br> <?= $view['houseno'];?>, <?= $view['street'];?>, <?= $view['brgy'];?>, <?= $view['municipal'];?></p>
                                <p><strong>Date & Time Applied:</strong><br> <?= $view['timeapplied'];?></p>
                                <p><strong>Narrative:</strong><br> <?= $view['contact'];?></p>
                                <hr style="border: 2px solid green; opacity: 1;">
                            </div>
                        </div>
                    </div>
