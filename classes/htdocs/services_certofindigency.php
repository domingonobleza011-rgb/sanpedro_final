    ...
    <div class="row justify-content-center text-center"> 
        <div class="col-12 col-md-10 col-lg-8"> 
            ...
            <div class="header mb-4">
                <h1 class="text1 display-4 fw-bold">Certificate of Indigency</h1>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg" name="nationality" value="<?= $userdetails['nationality']?>" required>
                                </div>
                            </div>
                        </div>

                        <!-- Address Section with 2x2 grid on mobile -->
                        <div class="mt-4 mb-2">
