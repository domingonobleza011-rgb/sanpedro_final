...
<head>
    ...
    <title>Barangay Clearance | Barangay San Pedro</title>
    ...
    <style>
        ...
        .hero-clearance .doc-icon {
            max-width: 90px;
            height: auto;
            transition: transform 0.3s ease;
        }
        .hero-clearance .doc-icon:hover {
...
<!-- ===== HERO BANNER ===== -->
<section class="hero-clearance text-center">
    <div class="container">
        <h1 class="mb-3">Barangay Clearance</h1>
        <p class="mb-4 opacity-75" style="font-size:1.1rem;">Secure your official Barangay Clearance quickly and easily</p>
    ...
    <div class="row g-4">
        ...
        <div class="col-6 col-md-3">
            <div class="step-card">
                ...
                <p>Claim your Barangay Clearance.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="container text-center mb-5">
    <button type="button" class="btn btn-request" data-bs-toggle="modal" data-bs-target="#clearanceModal">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title"><i class="bi bi-file-earmark-text me-2"></i>Barangay Clearance Request</h5>
            ...
            <form method="post" novalidate>
                <div class="modal-body">
                    ...
                    <!-- Address Info -->
                    <div class="form-section-title mt-4"><i class="bi bi-geo-alt me-1"></i> Address Information</div>
                    <div class="row g-3">
                        <div class="col-md-3">
                    ...
                    <input name="addedby" type="hidden" value="<?= htmlspecialchars($userdetails['surname'] . ' ' . $userdetails['firstname'] . ' ' . $userdetails['mname']) ?>">
                </div>
