                        ...
                        <div class="modal-body">
                            <form method="post" class="was-validated" enctype="multipart/form-data"> 
                                ...
                                <div class="row"> 
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input name="contact" type="text" class="form-control" placeholder="Enter Contact No." required>
                                            <div class="valid-feedback">Valid.</div>
                                            <div class="invalid-feedback">Please fill out this field.</div>
                                        </div>
                                    </div>
                                ...
                                <div class="row"> 
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="relation" class="mtop">Relation:</label>
                                            <input name="relation" type="text" class="form-control" placeholder="Enter Relation" required>
                                                <div class="valid-feedback">Valid.</div>
                                                <div class="invalid-feedback">Please fill out this field.</div>
                                        </div>
                                    </div>
