            ...
            <tr>
                <td>    
                    <form action="" method="post">
                        <a class="btn btn-primary" target="blank" style="width: 90px; font-size: 17px; border-radius:30px; margin-bottom: 2px;" href="barangayid_form.php?id_brgyid=<?= $view['id_brgyid'];?>">Generate</a> 
